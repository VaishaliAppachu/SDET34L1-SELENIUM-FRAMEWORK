...
public class CreateContactTandUpdateInfoTest extends BaseClass{
	@Test
	public void createContactTC1() throws EncryptedDocumentException, IOException
	{
		String contactname = ExcelOffice.getDataFromExcel("contacts", 2, 1)+JavaOffice.getRandomnumber(1000);	
		if(driver.getTitle().contains("vtiger"))
		{
			ExcelOffice.setExcelData("contacts", 17, 7, "login page is displayed");
			ExcelOffice.setExcelData("contacts", 17, 8, "Pass");
		}	
		if(driver.getTitle().contains("Home"))
		{
			ExcelOffice.setExcelData("contacts", 18, 7, "home page is displayed");
			ExcelOffice.setExcelData("contacts", 18, 8, "Pass");
		}		
		...
		{
			ExcelOffice.setExcelData("contacts", 19, 7, "contact page is displayed");
			ExcelOffice.setExcelData("contacts", 19, 8, "Pass");
		}			
		...
		if(driver.getTitle().contains("Contacts"))
		{
			ExcelOffice.setExcelData("contacts", 20, 7, "Contact information updated today");
			ExcelOffice.setExcelData("contacts", 20, 8, "Pass");
		}    
		if(driver.getTitle().contains("Contacts"))
		{
			ExcelOffice.setExcelData("contacts", 21, 7, "next contact page is displayed");
			ExcelOffice.setExcelData("contacts", 21, 8, "Pass");
		}    
		JavaOffice.printStatement("Sam contact information updated today");	
		Reporter.log("Sam contact information updated today");
	}
}
